    ...
    <div>
      ...
      <div className="w-full md:w-[50%] mx-auto md:rounded-2xl">
        ...
        <div className="md:grid grid-cols-2 space-x-0 ml-12">
          <div
            className={`border-2 border-gray-200 rounded-lg w-[70%] mx-auto h-56 hover:cursor-pointer hover:bg-gray-100 hover:border-green-600 ${person === 'client' ? 'border-green-600 bg-gray-100' : ""}`}
            onClick={() => handleSelectPerson('client')}
          >
          ...
          <div
            className={`border-2 border-gray-200 rounded-lg w-[70%] mx-auto h-56 hover:cursor-pointer hover:bg-gray-100 hover:border-green-600 ${person === 'freelancer' ? 'border-green-600 bg-gray-100' : ""}`}
            onClick={() => handleSelectPerson('freelancer')}
          >
            <div className="flex justify-between relative">
